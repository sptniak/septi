...
<div class="container col-12">
        ...
        <div class="carousel-inner" style=" width:100%; max-height: 432px !important; padding:0%;">
            <div class="carousel-item active">
                <img class="d-block w-100" src="<?php echo base_url(); ?>assets/h1.jpg" alt="First slide">
            </div>
        </div>
