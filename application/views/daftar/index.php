...
<body>
    ...
    <h2 style="color:red;">DAFTAR AKUN KDRI.CO</h2>
			<div class="Content">
					<div class="row-fluid">
						<form class= "user" action="action_page.php" method="post">
								<div class="form-group">
										<label for="email"><b>Username:</b><span>*</span></label>
                                        <input type="text" class="form-control" id="uname" name="uname" value="<?= set_value('name'); ?>" required>
								...
								<div class="form-group">
										...
										<input type="text" class="form-control" id="mail" name ="domisili" required>
								</div>
