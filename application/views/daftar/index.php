					...
					<div class="row-fluid">
						<form action="action_page.php">
								...
								<div class="form-group">
										...
										<input type="password" class="form-control" id="psww" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
										...
										<div class="form-group">
												...
												<input type="number" class="form-control" id="mail"required>
										</div>		
										<div class="form-group">
												<label><b>Pekerjaan:</b><span>*</span></label>
												<input type="text" class="form-control" id="psww" required>
										</div>
										<div class="form-group">
